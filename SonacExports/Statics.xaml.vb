...
Public Class Statics
    ...
    Private Sub Statics_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        Dim dt As DataTable = bm.ExecuteAdapter("select PoneComment,PoneHeader,CompanyName,CompanyTel from Statics")
    ...
    Private Sub btnSave_Click(sender As Object, e As RoutedEventArgs) Handles btnSave.Click
        ...
        If Md.Manager Then
            bm.ExecuteNonQuery("update Statics set PoneComment='" & PoneComment.Text.Replace("'", "''") & "',PoneHeader='" & PoneHeader.Text.Replace("'", "''") & "',CompanyName='" & CompanyName.Text.Replace("'", "''") & "',CompanyTel='" & CompanyTel.Text.Replace("'", "''") & "'")
        End If
